...
void setRes(void)
{
  ...
  wrReg(REG_COM3, 0); // REG_COM3 disable scaling - Vitor 14/11/2020 (Se habilitar escala, desloca a imagem no display)
  wrReg(REG_COM14,0x00); // Vitor 14/11/2020 (Se preencher esse campo, desloca a imagem no display)
